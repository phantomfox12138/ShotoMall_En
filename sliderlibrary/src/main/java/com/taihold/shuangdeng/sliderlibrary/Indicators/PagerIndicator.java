package com.taihold.shuangdeng.sliderlibrary.Indicators;
...
import com.taihold.shuangdeng.sliderlibrary.R;
        ...
        ViewPagerEx.OnPageChangeListener
{
    ...
    /**
     * This value is from
     * {@link com.taihold.shuangdeng.sliderlibrary.SliderAdapter} getRealCount()
     * represent
     *
    ...
    public PagerIndicator(Context context, AttributeSet attrs)
    {
        ...
        mPadding_top = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_padding_top,
                (int) pxFromDp(0));
        mPadding_bottom = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_padding_bottom,
                (int) pxFromDp(0));
        ...
        mUnSelectedPadding_Left = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_padding_left,
                (int) mPadding_left);
        mUnSelectedPadding_Right = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_padding_right,
                (int) mPadding_right);
        mUnSelectedPadding_Top = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_padding_top,
                (int) mPadding_top);
        mUnSelectedPadding_Bottom = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_padding_bottom,
                (int) mPadding_bottom);
    ...
    public void setIndicatorStyleResource(int selected, int unselected)
    {
        ...
        {
            mSelectedDrawable = mContext.getResources()
                    .getDrawable(mUserSetSelectedIndicatorResId);
        }
        if (unselected == 0)
        {
        ...
        {
            mUnselectedDrawable = mContext.getResources()
                    .getDrawable(mUserSetUnSelectedIndicatorResId);
        }
