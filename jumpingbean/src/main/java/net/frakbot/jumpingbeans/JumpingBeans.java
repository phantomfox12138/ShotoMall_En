 ...
 * you want to happen in most cases.</li>
...
public final class JumpingBeans
{
    ...
    /**
     * Create an instance of the {@link Builder} applied to the provided
     * {@code TextView}.
     *
     * @param textView
    ...
    public static class Builder
    {
        ...
        {
            CharSequence lastChar = text.subSequence(text.length() - 1,
                    text.length());
        ...
        private static boolean endsWithThreeEllipsisDots(CharSequence text)
        {
            ...
            CharSequence lastThreeChars = text.subSequence(text.length()
                    - THREE_DOTS_ELLIPSIS_LENGTH, text.length());
         ...
         */
        @NonNull
        public Builder makeTextJump(@IntRange(from = 0) int startPos,
        ...
        private static CharSequence ensureTextCanJump(int startPos, int endPos,
                CharSequence text)
        {
            if (text == null)
            {
                throw new NullPointerException(
                        "The textView text must not be null");
            }
         ...
         * animating. The rest of the time will be spent "resting".
         *
         * @param animatedRange
         ...
         */
        @NonNull
        public Builder setAnimatedDutyCycle(
         ...
         */
        @NonNull
        public Builder setWavePerCharDelay(
        ...
        private JumpingBeansSpan[] buildWavingSpans(SpannableStringBuilder sbb)
        {
            ...
            {
                JumpingBeansSpan jumpingBean = new JumpingBeansSpan(textView,
                        loopDuration, pos - startPos, waveCharDelay, animRange);
                sbb.setSpan(jumpingBean,
                        pos,
                        pos + 1,
        ...
        {
            JumpingBeansSpan[] spans;
            spans = new JumpingBeansSpan[] { new JumpingBeansSpan(textView,
                    loopDuration, 0, 0, animRange) };
            sbb.setSpan(spans[0],
                    startPos,
                    endPos,
                    Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
